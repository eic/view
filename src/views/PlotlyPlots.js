      ...
      <Container fluid>
        <Row>
          <Col md="6">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Some plotly plot</Card.Title>
                <p className="card-category">Do we need this?</p>
              </Card.Header>
              <Card.Body>
                <Plot 
                  data={[
                  ...
                  // We probably don't need this as Card will define plot size
              ...
              <Card.Footer>
                <div className="legend">
                  ...
                  This is card footer! <i className="fas fa-circle text-danger"></i>
                </div>                
              </Card.Footer>
            </Card>
          </Col>
